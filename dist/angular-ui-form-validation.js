...
.factory('templateRetriever', ['$http', '$q', function ($http, $q){
	return {
...
angular_ui_form_validations = (function(){
    ...
    .factory('customValidationUtil', ['templateRetriever', '$q', '$timeout', '$log', function (templateRetriever, $q, $timeout, $log) {
        return {
    ...
    .directive('input', ['customValidationUtil', function (customValidationUtil) {
        return {
            require: '?ngModel',
            restrict: 'E',
    ...
    .directive('select', ['customValidationUtil', function (customValidationUtil) {
        return {
            require: '?ngModel',
            restrict: 'E',
            link: customValidationUtil.createValidationLink(dynamicallyDefinedValidation)
    ...
    .directive('button', ['customValidationUtil', function (customValidationUtil) {
        return {
            restrict: 'E',
            link: submitLink
        };
    ...
    .directive('a', ['customValidationUtil', function (customValidationUtil) {
        return {
            restrict: 'E',
            link: submitLink
        };
...
(function () {
    ...
    extendCustomValidations.config(['$compileProvider', 'myValidationsProvider', function ($compileProvider, myValidationsProvider) {
        myValidationsProvider.setCompileProvider($compileProvider);
    }]);

    extendCustomValidations.run(['myValidations', function (myValidations) {
