...
(function(){
    ...
    function(customValidation) {
        extendCustomValidations.directive('input', ['customValidationUtil', function (customValidationUtil) {
            return {
                require: '?ngModel',
                restrict: 'E',
        ...
        extendCustomValidations.directive('textarea', ['customValidationUtil', function (customValidationUtil) {
            return {
                require: '?ngModel',
                restrict: 'E',
                link: customValidationUtil.createValidationLink(customValidation)
