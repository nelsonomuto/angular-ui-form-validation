/**
 * @license AngularJS v1.3.0-local+sha.adcc5a0
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.3.0-local+sha.adcc5a0/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.3.0-local+sha.adcc5a0',    // all of these placeholder strings will be replaced by grunt's
